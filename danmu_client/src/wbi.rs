// wbi 计算代码，部分代码来自来自：https://github.com/SocialSisterYi/bilibili-API-collect/blob/master/docs/misc/sign/wbi.md#rust
use anyhow::Result;
...
pub async fn get_wbi_keys(cookies: HeaderMap) -> Result<(String, String)> {
    ...
    let ResWbi {
        ...
        .await?;
    Ok((
        take_filename(wbi_img.img_url),
        take_filename(wbi_img.sub_url),
    ))
}
